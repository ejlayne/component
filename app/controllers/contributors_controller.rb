class ContributorsController < ApplicationController
  ...
  def create
    @contributor = Contributor.new(params[:contributor].permit(:username, :password, :email, :profile_id))

    respond_to do |format|
      if @contributor.save
        format.html { redirect_to contributors_path, notice: 'Contributor was successfully created.' }
